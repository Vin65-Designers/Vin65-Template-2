...
<cfset bodybgcolor="##dae0c9">
<cfset containerbgcolor="##ffffff">
<cfset footerbgcolor="##dae0c9">

<cfset textcolor="##111">
<cfset headlinecolor="##4d601e">

<cfset linkcolor="##7fab12">
<cfset menubgcolor="##4d601e">
<cfset menuhovercolor="##748E30">
<cfset dropdownhovercolor="##4D601E">
<cfset subscribeinputcolor="##dae0c9">

@charset "utf-8";
/* CSS Document */
/* Light Green CSS Styles */
	...
	##footerLegal { float: left; padding: 1em 0; }
		##footerLegal ul { list-style: none; margin: 0; padding: 0; overflow: hidden; }
			##footerLegal ul li { float: left; margin: 0; padding: 0; }
				##footerLegal ul li a { font-size: 0.8em; color: ##000000; position: relative; display: inline-block; text-decoration: none; margin: 0; padding-right: 10px; }
				##footerLegal ul li a:hover { text-decoration: underline; }
		##footerLegal p { clear: both; font-size: 0.8em; color: ##666; }
...
/*---------------------------------------------------------------------------*/
	...
	button.altLargeBtn span { background: transparent url(../images/buttons/btn_large_alt_sprite.gif) no-repeat left top; color: ##000; }
